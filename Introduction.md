...
-	In Gephi you can use various algorithms. [ForceAtlas2](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679){:target="blank"} is the most used algorithm. If you use Gephi for academic research, you will need to understand how the algorithm works on at least a basic level. To do this, you can read up on the algorithms in the papers written by the developers.
